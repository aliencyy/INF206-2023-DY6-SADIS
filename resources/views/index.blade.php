...
<div class="flex-wrap mx-4 ">
  ...
  <div class="row flex-wrap" style="text-align: center;">
    <div class="col-3 m-2">
      <h1 class="fw-bolder fs-2" style="color: #558E7A; ">MEDIS</h1>
    </div>
    <div class="col-3 m-2">
      <h1 class="fw-bolder fs-2" style="color: #558E7A;">PERHOTELAN</h1>
    </div>
    <div class="col-3 m-2">
      <h1 class="fw-bolder fs-2" style="color: #558E7A;">ELEKTRONIK</h1>
    </div>
    <div class="col-2 m-2">
      <h1 class="fw-bolder fs-2" style="color: #558E7A;">MANUFAKTUR</h1>
    </div>

    <!-- END Tulisan Keterangan Judul Ketiga-->

    <div class="row flex-wrap " style="position: relative; margin-bottom: 10%;">
      <div class="col-3 m-2 ms-auto">
        <p class="fs-3" style="color: black; ">Masker bekas pakai, jarum suntik, obat-obatan expired</p>
      </div>
      <div class="col-3 m-2 ms-auto">
        <p class="fs-3" style="color: black;">Lampu bekas, baterai bekas</p>
      </div>
      <div class="col-3 m-2 ms-auto">
        <p class=" fs-3" style="color: black;">Televisi rusak, ponsel rusak</p>
      </div>
      <div class="col-2 m-2 ms-auto">
        <p class="fs-3" style="color: black; text-align: center;">Sampo, sabun, kosmetik yang expired</p>
      </div>
