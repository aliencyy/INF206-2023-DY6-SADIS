                ...
                <div class="container text-center">
                    <div class="row align-items-center p-4">
                        ...
                        <button  type="button" class="col p-3 mx-3 rounded-6 border-0" style="background-color: #A3D8BF; border-radius: 10px; ">
                            <a href="/buangsampah" class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" style="color: black; font-size: 18px;">Buat Pengajuan pengambilan sampah</a></button>
                        <!-- Button Daftar pelanggan-->
                        <button type="button" class="col p-3 mx-3 rounded-6 border-0" style="background-color: #A3D8BF; border-radius: 10px;">
                            <a href="/order" class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" style="color: black; font-size: 18px;">Riwayat pembuangan sampah</a></button>
                        
                        <button type="button" class="col p-3 mx-3 rounded-6 border-0" style="background-color: #A3D8BF; border-radius: 10px;">
                            <a href="/langganan" class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" style="color: black; font-size: 18px;">Subscription</a></button>
                    </div>
                </div>
