    ...
    <nav class="navbar bg-body-tertiary">
      ...
      <div class="container" style= "background-color: #D9F9EE;">
        ...
        <div class="button-navbar" >
          <button onclick="location.href='/login'" type="button" class="btn btn-primary rounded-5 border-0 mx-3"  style="background-color: #A3D8BF; -webkit-text-fill-color: black; --bs-btn-padding-y: .5rem; --bs-btn-padding-x: 1.5rem; --bs-btn-font-size: 1.25rem;">Daftar / Masuk</button>
